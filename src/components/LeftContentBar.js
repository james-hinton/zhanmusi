...
const LeftContentBar = ({pokeData}) => {
    ...
    const [image, setImage] = useState('https://avatars.githubusercontent.com/u/63542818?v=4')
        ...
        <div className="content__left">
            ...
            <div className='info'>
                ...
                {abilities && (
                    ...
                    <InfoPanel title={'Abilities'} value={abilities.map((item,i) => <li key={i}>{ capitalizeFirstLetter(item)}</li>)
                }/>
