...
const whatsHappening = [
  {
    type: "trending",
    title: "Why did the chicken cross the road? To get to the other side...duh!",
    time: "1 hour ago",
    count: "1.2K Tweets",
  ...
  {
    type: "trending",
    title: "I just spilled my coffee all over my keyboard. Now my keys are extra caffeinated and typing really fast",
    time: "1 hour ago",
    count: "1.2K Tweets",
  },
];
